...
// Mirror of src/lib/placement.ts — keep in sync. Same numbers the admin
// "re-tidy layout" button uses (src/app/api/admin/reposition/route.ts).
const NO_OVERLAP_X = 275;
const NO_OVERLAP_Y = 475;
